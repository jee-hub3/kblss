                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="w-full aspect-[4/5] rounded-[2rem] overflow-hidden">
                                    <img src="/image/team.jpg" alt="KBLs 팀 단체 사진" className="w-full h-full object-cover rounded-3xl shadow-lg" />
                                </div>
                                ...
                                >
                                    <img src="/image/workshop.png" alt="KBLs 워크샵 및 회의" className="w-full h-full object-cover" />
                                </motion.div>
