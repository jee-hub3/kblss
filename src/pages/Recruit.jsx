                            ...
                            >
                                <div className="w-full bg-white rounded-[2rem] border border-slate-200 shadow-sm mb-12 p-8 md:p-12">
                                    <div className="mb-10 text-center">
                                        <h3 className="text-2xl font-bold text-slate-900 mb-3">2026 KBLs 상반기 지원서</h3>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-10 max-w-2xl mx-auto">
                                        ...
                                        <div className="space-y-6 bg-slate-50 border border-slate-100 p-6 md:p-8 rounded-2xl">
                                            <h4 className="font-bold text-lg text-slate-800 mb-4 border-b border-slate-200 pb-2">기본 인적사항</h4>
                                        ...
                                        <div className="pt-6">
                                            <button
                                                ...
                                                className="w-full py-4 bg-brand-accent hover:bg-brand-600 disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold rounded-xl text-lg shadow-md transition-all flex items-center justify-center"
                                            >
                                                {isSubmitting ? (
