...
export const RECRUIT_SCHEDULE = {
     ...
     */
    /* ⚠️ 임시 개방 — 오너 지시(2026-08-26, 테스트 목적). 되돌릴 값: open: "2026-08-28".
       ★ 되돌리는 시각: 2026-08-26 21:00 KST. 그때까지 이 파일을 다른 이유로 고치지 말 것
         (되돌리기가 revert 한 번으로 끝나야 한다).
       지금은 위 steps의 표시("8/28~9/05")와 일부러 어긋나 있다 — 화면 타임라인은
       8/28로 두고 접수만 미리 연 상태다. 되돌리면 두 값이 다시 8/28로 맞는다.
       이 상태에서는 실제 지원자의 조기 제출이 노션에 그대로 저장된다. */
    docWindow: { open: "2026-08-26", close: "2026-09-05" },
}
